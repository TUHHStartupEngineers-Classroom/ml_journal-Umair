...
######### excluding features that should not be unscwed#############
...
############### putting it in general function #################
...
data_cor %>%
  ...
  ##, contains("department"),contains("Employee Number"), contains("Job Satisfaction")
  
  train_tbl %>%
    select(Attrition_Yes, contains("JobSatisfaction")) %>%
  ...
  h2o.loadModel("04_Modeling/h20_models/GBM_3_AutoML_20210528_151021")
  
  
  
  
  # Choose whatever model you want
  stacked_ensemble_h2o <- h2o.loadModel("04_Modeling/h20_models/GBM_3_AutoML_20210528_151021")
  ...
  deep_learning_h2o <- h2o.loadModel("04_Modeling/h20_models/GBM_3_AutoML_20210528_151021")
